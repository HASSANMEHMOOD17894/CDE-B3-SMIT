                                    # Assignments A1 (part 1)

# 1.Print Your Name with your Father name and Date of birth using suitable escape sequence charactor

name = "Hassan Mehmood"
father_name = "Mehmood Ahmed"
date_of_birth = "01/01/2000"
print("Name: {}\nFather's Name: {}\nDate of Birth: {}".format(name, father_name, date_of_birth))


# 2.Write your small bio using variables and print it using print function

bio = "My name is Hassan Mehmood. I am a student at SMIT. I love programming and exploring new technologies."
print(bio);
